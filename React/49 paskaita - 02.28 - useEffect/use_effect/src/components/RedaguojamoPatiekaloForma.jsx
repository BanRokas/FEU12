const RedaguojamoPatiekaloForma = ({ formInputs, setFormInputs, setArRedaguojame, arRedaguojame, redaguotiPatiekala}) => {
  const formSubmit = e => {
    e.preventDefault();
    ...
    redaguotiPatiekala(editedCardData);
    ...
    setArRedaguojame(false);
  }
  const atsauktiRedagavima = () => {
    setArRedaguojame(false);
    setFormInputs({
      pavadinimas: '',
      nuotrauka: '',
  ...
  return (
    <section>
      ...
      <form onSubmit={formSubmit}>
        ...
        /><br />
        <input type="submit" value="Redaguoti patiekalą" />
      </form>
      <button
        onClick={atsauktiRedagavima}
      >Atšaukti redagavimą</button>
    </section>
  );
}
 
export default RedaguojamoPatiekaloForma;